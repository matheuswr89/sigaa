...
export const parseAtividades = (html: HTMLElement, navigation: any) => {
  try {
    ...
    recordErrorFirebase(e, '-parseAtividades');
    navigation.goBack();
  }
};

export const parseDisciplinas = (html: HTMLElement, navigation: any) => {
  try {
    ...
    recordErrorFirebase(e, '-parseDisciplinas');
    navigation.goBack();
  }
};
